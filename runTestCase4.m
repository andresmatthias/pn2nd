...
% RUNTESTCASE4 Run the test case 4 and visualize the results.
% 
%   User instruction:
%       1) Use generateTestCase4.m first to generate second-order 
%          formulation of PN equations.
%       2) Execute genMeshTestCase4.sh in folder ./testCases/testCase4 in
%           the command line (knowing dolfin and gmsh) 
%       3) Run runTestCase4.py in Python (with FEniCS) in folder ./FEniCS .
%       4) Run runDiscreteOrdinatesTestCase4.m
...
meshName = 'meshTestCase4_0';
meshNameFine = 'meshTestCase4_1';
...
%     surface2tikz_plain(figure(1),'./testCase4_DO23','colorbar','horizontal','standalone',false,'dpi',500);
%     surface2tikz_plain(figure(3),'./testCase4_P1_2ndCoarse','colorbar','horizontal','standalone',false,'dpi',500);
%     surface2tikz_plain(figure(5),'./testCase4_P3_2ndCoarse','colorbar','horizontal','standalone',false,'dpi',500);
%     surface2tikz_plain(figure(7),'./testCase4_P5_2ndCoarse','colorbar','horizontal','standalone',false,'dpi',500);
end
