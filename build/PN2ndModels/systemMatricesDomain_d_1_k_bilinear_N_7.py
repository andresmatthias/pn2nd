...
#-------- system matrices --------
    ...
    systemMatricesDomain['Kzz'] = [[0.33333333/(0.33333333*sigma_s - 1.0*sigma_t), 0.2981424/(0.33333333*sigma_s - 1.0*sigma_t), 0.0, 0.0],
        [0.2981424/(0.33333333*sigma_s - 1.0*sigma_t), -(1.0*(0.085714286*sigma_s - 0.52380952*sigma_t))/(0.33333333*sigma_s*sigma_t - 1.0*sigma_t**2), -0.25555063/sigma_t, 0.0],
        [0.0, -0.25555063/sigma_t, -0.50649351/sigma_t, -0.25213645/sigma_t],
